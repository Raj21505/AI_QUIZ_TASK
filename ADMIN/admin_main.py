...
class Admin_Quiz:
    ...
    def admin(self):
        ...
        if obj3.authenticate(username , password) == True:
                ...
                activity = st.selectbox(label="Activity" , options=["Select" , "1 --> Add Question" , "2 --> Delete Question" , "3 --> Update Question" , "4 --> Show dictionary of questions" , "5 --> Exit"] , index=None)
                print()
